...
define linkonce_odr dso_local void @_Z7callmodILi10ELi23EEvv() #6 comdat {
  ...
  call void @klee_div_zero_check(i64 %21)
  %22 = urem i64 %20, %21, !klee.check.div !21
  store i64 %22, i64* %5, align 8
  %23 = load i64, i64* %5, align 8
  store i32 10, i32* %6, align 4
  store i32 23, i32* %7, align 4
  %24 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %6, i32* noundef nonnull align 4 dereferenceable(4) %7)
  %25 = load i32, i32* %24, align 4
  %int_cast_to_i64 = zext i32 %25 to i64
  call void @klee_overshift_check(i64 32, i64 %int_cast_to_i64)
  %26 = shl i32 1, %25, !klee.check.shift !21
  %27 = sub nsw i32 %26, 1
  %28 = sext i32 %27 to i64
  %29 = and i64 %23, %28
  store i64 %29, i64* %5, align 8
  %30 = call i64 @_ZNK4UIntILi10EmLi1EErmILi23EEES_IXclL_ZNS0_4cminEiiELi10ET_EENSt11conditionalIXleclL_ZNS0_4cminEiiELi10ET_ELi8EEhmE4typeEXquleclL_ZNS0_4cminEiiELi10ET_ELi8ELi1EdvmiplclL_ZNS0_4cminEiiELi10ET_ELi64ELi1ELi64EEERKS_IXT_ENS2_IXleT_Li8EEhmE4typeEXquleT_Li8ELi1EdvmiplT_Li64ELi1ELi64EEE(%class.UInt* noundef nonnull align 8 dereferenceable(8) %3, %class.UInt.0* noundef nonnull align 8 dereferenceable(8) %4)
  %31 = getelementptr inbounds %class.UInt, %class.UInt* %9, i32 0, i32 0
  %32 = getelementptr inbounds %"struct.std::array", %"struct.std::array"* %31, i32 0, i32 0
  %33 = bitcast [1 x i64]* %32 to i64*
  store i64 %30, i64* %33, align 8
  %34 = load i64, i64* %5, align 8
  call void @_ZN4UIntILi10EmLi1EEC2Em(%class.UInt* noundef nonnull align 8 dereferenceable(8) %10, i64 noundef %34)
  %35 = call i8 @_ZNK4UIntILi10EmLi1EEeqERKS0_(%class.UInt* noundef nonnull align 8 dereferenceable(8) %9, %class.UInt* noundef nonnull align 8 dereferenceable(8) %10)
  %36 = getelementptr inbounds %class.UInt.1, %class.UInt.1* %8, i32 0, i32 0
  %37 = getelementptr inbounds %"struct.std::array.2", %"struct.std::array.2"* %36, i32 0, i32 0
  %38 = bitcast [1 x i8]* %37 to i8*
  store i8 %35, i8* %38, align 1
  %39 = call noundef zeroext i1 @_ZNK4UIntILi1EhLi1EEcvbEv(%class.UInt.1* noundef nonnull align 1 dereferenceable(1) %8)
  %40 = xor i1 %39, true
  br i1 %40, label %41, label %42

41:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.5, i64 0, i64 0), i32 noundef 26, i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @__PRETTY_FUNCTION__._Z7callmodILi10ELi23EEvv, i64 0, i64 0)) #13
  unreachable
