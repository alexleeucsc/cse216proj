...
define linkonce_odr dso_local void @_Z7calldivILi10ELi20EEvv() #6 comdat {
  ...
  call void @klee_div_zero_check(i64 %20)
  %21 = udiv i64 %19, %20, !klee.check.div !21
...
44:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([44 x i8], [44 x i8]* @.str.5, i64 0, i64 0), i32 noundef 29, i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @__PRETTY_FUNCTION__._Z7calldivILi10ELi20EEvv, i64 0, i64 0)) #13
  unreachable
