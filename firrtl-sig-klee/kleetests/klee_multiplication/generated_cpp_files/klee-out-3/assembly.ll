...
define dso_local void @_Z8callmultv() #5 {
  ...
  call void @klee_make_symbolic(i8* noundef %6, i64 noundef 8, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  %7 = bitcast i64* %2 to i8*
  call void @klee_make_symbolic(i8* noundef %7, i64 noundef 8, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  %8 = load i64, i64* %1, align 8
  %9 = and i64 %8, 1023
  store i64 %9, i64* %1, align 8
  %10 = load i64, i64* %2, align 8
  %11 = and i64 %10, 4194303
  store i64 %11, i64* %2, align 8
  %12 = load i64, i64* %1, align 8
  call void @_ZN4UIntILi10EmLi1EEC2Em(%class.UInt* noundef nonnull align 8 dereferenceable(8) %3, i64 noundef %12)
  %13 = load i64, i64* %2, align 8
  call void @_ZN4UIntILi22EmLi1EEC2Em(%class.UInt.0* noundef nonnull align 8 dereferenceable(8) %4, i64 noundef %13)
  %14 = load i64, i64* %1, align 8
  %15 = load i64, i64* %2, align 8
  %16 = mul i64 %14, %15
  store i64 %16, i64* %5, align 8
  %17 = load i64, i64* %5, align 8
  %18 = and i64 %17, poison
...
24:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.4, i64 0, i64 0), i32 noundef 27, i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @__PRETTY_FUNCTION__._Z8callmultv, i64 0, i64 0)) #13
  unreachable
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef nonnull align 8 dereferenceable(8) i64* @_ZNSt5arrayImLm1EEixEm(%"struct.std::array"* noundef nonnull align 8 dereferenceable(8) %0, i64 noundef %1) #8 comdat align 2 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef nonnull align 8 dereferenceable(8) i64* @_ZNSt14__array_traitsImLm1EE6_S_refERA1_Kmm([1 x i64]* noundef nonnull align 8 dereferenceable(8) %0, i64 noundef %1) #8 comdat align 2 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef i32 @_ZN4UIntILi10EmLi1EE3capEi(i32 noundef %0) #8 comdat align 2 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef i32 @_ZN4UIntILi22EmLi1EE3capEi(i32 noundef %0) #8 comdat align 2 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = srem i32 %3, 64
...
define dso_local void @klee_overshift_check(i64 %0, i64 %1) #10 !dbg !24 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !30, metadata !DIExpression()), !dbg !32
  call void @llvm.dbg.value(metadata i64 %1, metadata !31, metadata !DIExpression()), !dbg !32
  %3 = icmp ult i64 %1, %0, !dbg !33
  br i1 %3, label %5, label %4, !dbg !35

4:                                                ; preds = %2
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2.6, i64 0, i64 0)) #13, !dbg !36
  unreachable, !dbg !36
...
declare !dbg !39 dso_local void @klee_report_error(i8*, i32, i8*, i8*) local_unnamed_addr #12
...
!22 = !{!"True"}
!23 = distinct !{!23, !20}
!24 = distinct !DISubprogram(name: "klee_overshift_check", scope: !25, file: !25, line: 20, type: !26, scopeLine: 20, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !29)
!25 = !DIFile(filename: "src/runtime/Intrinsic/klee_overshift_check.c", directory: "/build/klee/parts/klee")
!26 = !DISubroutineType(types: !27)
!27 = !{null, !28, !28}
!28 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!29 = !{!30, !31}
!30 = !DILocalVariable(name: "bitWidth", arg: 1, scope: !24, file: !25, line: 20, type: !28)
!31 = !DILocalVariable(name: "shift", arg: 2, scope: !24, file: !25, line: 20, type: !28)
!32 = !DILocation(line: 0, scope: !24)
!33 = !DILocation(line: 21, column: 13, scope: !34)
!34 = distinct !DILexicalBlock(scope: !24, file: !25, line: 21, column: 7)
!35 = !DILocation(line: 21, column: 7, scope: !24)
!36 = !DILocation(line: 27, column: 5, scope: !37)
!37 = distinct !DILexicalBlock(scope: !34, file: !25, line: 21, column: 26)
!38 = !DILocation(line: 29, column: 1, scope: !24)
!39 = !DISubprogram(name: "klee_report_error", scope: !40, file: !40, line: 73, type: !41, flags: DIFlagPrototyped | DIFlagNoReturn, spFlags: DISPFlagOptimized, retainedNodes: !4)
!40 = !DIFile(filename: "src/include/klee/klee.h", directory: "/build/klee/parts/klee")
