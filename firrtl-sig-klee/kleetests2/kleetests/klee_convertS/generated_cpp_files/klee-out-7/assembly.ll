; ModuleID = 'generated_cpp_files/klee_shiftleft_11_22.bc'
source_filename = "generated_cpp_files/klee_shiftleft_11_22.cpp"
...
$_Z7callshlILi11ELi22EEvv = comdat any
...
$_ZNK4UIntILi11EmLi1EE6asSIntEv = comdat any
...
@.str.4 = private unnamed_addr constant [45 x i8] c"generated_cpp_files/klee_shiftleft_11_22.cpp\00", align 1
@__PRETTY_FUNCTION__._Z7callshlILi11ELi22EEvv = private unnamed_addr constant [34 x i8] c"void callshl() [w1 = 11, w2 = 22]\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_klee_shiftleft_11_22.cpp, i8* null }]
...
define dso_local noundef i32 @main() #5 {
  ...
  call void @_Z7callshlILi11ELi22EEvv()
  ret i32 0
}

; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local void @_Z7callshlILi11ELi22EEvv() #6 comdat {
  ...
  call void @_ZN4UIntILi11EmLi1EEC2Em(%class.UInt* noundef nonnull align 8 dereferenceable(8) %2, i64 noundef %8)
  ...
  %11 = call i64 @_ZNK4UIntILi11EmLi1EE6asSIntEv(%class.UInt* noundef nonnull align 8 dereferenceable(8) %2)
  ...
  call void @_ZN4SIntILi11EEC2El(%class.SInt* noundef nonnull align 8 dereferenceable(8) %6, i64 noundef %16)
  %17 = call i8 @_ZNK4SIntILi11EEeqERKS0_(%class.SInt* noundef nonnull align 8 dereferenceable(8) %5, %class.SInt* noundef nonnull align 8 dereferenceable(8) %6)
...
23:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([45 x i8], [45 x i8]* @.str.4, i64 0, i64 0), i32 noundef 20, i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @__PRETTY_FUNCTION__._Z7callshlILi11ELi22EEvv, i64 0, i64 0)) #15
  unreachable
...
; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local i64 @_ZNK4UIntILi11EmLi1EE6asSIntEv(%class.UInt* noundef nonnull align 8 dereferenceable(8) %0) #6 comdat align 2 {
  %2 = alloca %class.SInt, align 8
  %3 = alloca %class.UInt*, align 8
  store %class.UInt* %0, %class.UInt** %3, align 8
  %4 = load %class.UInt*, %class.UInt** %3, align 8
  call void @_ZN4SIntILi11EEC2ERK4UIntILi11EmLi1EE(%class.SInt* noundef nonnull align 8 dereferenceable(8) %2, %class.UInt* noundef nonnull align 8 dereferenceable(8) %4)
  call void @_ZN4SIntILi11EE11sign_extendEi(%class.SInt* noundef nonnull align 8 dereferenceable(8) %2, i32 noundef 10)
...
define linkonce_odr dso_local i8 @_ZNK4SIntILi11EEeqERKS0_(%class.SInt* noundef nonnull align 8 dereferenceable(8) %0, %class.SInt* noundef nonnull align 8 dereferenceable(8) %1) #6 comdat align 2 {
  ...
  %10 = call i8 @_ZNK4UIntILi11EmLi1EEeqERKS0_(%class.UInt* noundef nonnull align 8 dereferenceable(8) %7, %class.UInt* noundef nonnull align 8 dereferenceable(8) %9)
...
define linkonce_odr dso_local void @_ZN4SIntILi11EEC2El(%class.SInt* noundef nonnull align 8 dereferenceable(8) %0, i64 noundef %1) unnamed_addr #4 comdat align 2 {
  ...
  call void @_ZN4UIntILi11EmLi1EEC2Em(%class.UInt* noundef nonnull align 8 dereferenceable(8) %6, i64 noundef %7)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN4SIntILi11EEC2ERK4UIntILi11EmLi1EE(%class.SInt* noundef nonnull align 8 dereferenceable(8) %0, %class.UInt* noundef nonnull align 8 dereferenceable(8) %1) unnamed_addr #9 comdat align 2 {
  %3 = alloca %class.SInt*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_klee_shiftleft_11_22.cpp() #0 section ".text.startup" {
...
entry:
  call void @_GLOBAL__sub_I_klee_shiftleft_11_22.cpp()
  ret void
}
