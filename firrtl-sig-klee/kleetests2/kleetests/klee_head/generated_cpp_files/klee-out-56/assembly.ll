...
$_ZNK4UIntILi14EmLi1EE4headILi6EEES_IXT_ENSt11conditionalIXleT_Li8EEhmE4typeEXquleT_Li8ELi1EdvmiplT_Li64ELi1ELi64EEEv = comdat any
...
define linkonce_odr dso_local void @_Z8callheadILi14ELi6EEvv() #6 comdat {
  ...
  %14 = call i8 @_ZNK4UIntILi14EmLi1EE4headILi6EEES_IXT_ENSt11conditionalIXleT_Li8EEhmE4typeEXquleT_Li8ELi1EdvmiplT_Li64ELi1ELi64EEEv(%class.UInt* noundef nonnull align 8 dereferenceable(8) %2)
  ...
  call void @_ZN4UIntILi6EhLi1EEC2Em(%class.UInt.2* noundef nonnull align 1 dereferenceable(1) %6, i64 noundef %18)
  %19 = call i8 @_ZNK4UIntILi6EhLi1EEeqERKS0_(%class.UInt.2* noundef nonnull align 1 dereferenceable(1) %5, %class.UInt.2* noundef nonnull align 1 dereferenceable(1) %6)
...
25:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0), i32 noundef 21, i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @__PRETTY_FUNCTION__._Z8callheadILi14ELi6EEvv, i64 0, i64 0)) #13
  unreachable
...
; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local i8 @_ZNK4UIntILi14EmLi1EE4headILi6EEES_IXT_ENSt11conditionalIXleT_Li8EEhmE4typeEXquleT_Li8ELi1EdvmiplT_Li64ELi1ELi64EEEv(%class.UInt* noundef nonnull align 8 dereferenceable(8) %0) #6 comdat align 2 {
