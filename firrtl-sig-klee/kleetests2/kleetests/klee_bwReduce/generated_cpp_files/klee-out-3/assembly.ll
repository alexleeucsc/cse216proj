...
define linkonce_odr dso_local void @_Z12callbwreduceILi13EEvv() #7 comdat {
  ...
  %14 = call i8 @_ZNK4UIntILi13EmLi1EE4andrEv(%class.UInt* noundef nonnull align 8 dereferenceable(8) %2)
...
25:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i32 noundef 29, i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @__PRETTY_FUNCTION__._Z12callbwreduceILi13EEvv, i64 0, i64 0)) #13
  unreachable
