...
define dso_local noundef i64 @_Z18bitwise_and_reducem(i64 noundef %0) #5 {
...
10:                                               ; preds = %7
  ...
  call void @klee_overshift_check(i64 64, i64 %13)
  %14 = lshr i64 %11, %13, !klee.check.shift !19
  %15 = and i64 %14, 1
...
define linkonce_odr dso_local void @_Z12callbwreduceILi14EEvv() #7 comdat {
  ...
  %13 = call noundef i64 @_Z18bitwise_and_reducem(i64 noundef %12)
  store i64 %13, i64* %3, align 8
  %14 = call i8 @_ZNK4UIntILi14EmLi1EE4andrEv(%class.UInt* noundef nonnull align 8 dereferenceable(8) %2)
...
25:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i32 noundef 29, i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @__PRETTY_FUNCTION__._Z12callbwreduceILi14EEvv, i64 0, i64 0)) #13
  unreachable
