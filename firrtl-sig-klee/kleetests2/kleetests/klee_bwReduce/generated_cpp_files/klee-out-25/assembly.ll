...
33:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i32 noundef 38, i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @__PRETTY_FUNCTION__._Z12callbwreduceILi10EEvv, i64 0, i64 0)) #13
  unreachable
...
49:                                               ; preds = %34
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i32 noundef 45, i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @__PRETTY_FUNCTION__._Z12callbwreduceILi10EEvv, i64 0, i64 0)) #13
  unreachable
...
50:                                               ; preds = %34
  ...
  %53 = call noundef i64 @_Z17bitwise_or_reducemm(i64 noundef %52, i64 noundef 10)
...
65:                                               ; preds = %50
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i32 noundef 52, i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @__PRETTY_FUNCTION__._Z12callbwreduceILi10EEvv, i64 0, i64 0)) #13
  unreachable
...
define dso_local void @klee_overshift_check(i64 %0, i64 %1) #10 !dbg !31 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !37, metadata !DIExpression()), !dbg !39
  call void @llvm.dbg.value(metadata i64 %1, metadata !38, metadata !DIExpression()), !dbg !39
  %3 = icmp ult i64 %1, %0, !dbg !40
  br i1 %3, label %5, label %4, !dbg !42

4:                                                ; preds = %2
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.7, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2.8, i64 0, i64 0)) #13, !dbg !43
  unreachable, !dbg !43
...
declare !dbg !46 dso_local void @klee_report_error(i8*, i32, i8*, i8*) local_unnamed_addr #12
...
!29 = distinct !{!29, !21}
!30 = distinct !{!30, !21}
!31 = distinct !DISubprogram(name: "klee_overshift_check", scope: !32, file: !32, line: 20, type: !33, scopeLine: 20, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !17, retainedNodes: !36)
!32 = !DIFile(filename: "src/runtime/Intrinsic/klee_overshift_check.c", directory: "/build/klee/parts/klee")
!33 = !DISubroutineType(types: !34)
!34 = !{null, !35, !35}
!35 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!36 = !{!37, !38}
!37 = !DILocalVariable(name: "bitWidth", arg: 1, scope: !31, file: !32, line: 20, type: !35)
!38 = !DILocalVariable(name: "shift", arg: 2, scope: !31, file: !32, line: 20, type: !35)
!39 = !DILocation(line: 0, scope: !31)
!40 = !DILocation(line: 21, column: 13, scope: !41)
!41 = distinct !DILexicalBlock(scope: !31, file: !32, line: 21, column: 7)
!42 = !DILocation(line: 21, column: 7, scope: !31)
!43 = !DILocation(line: 27, column: 5, scope: !44)
!44 = distinct !DILexicalBlock(scope: !41, file: !32, line: 21, column: 26)
!45 = !DILocation(line: 29, column: 1, scope: !31)
!46 = !DISubprogram(name: "klee_report_error", scope: !47, file: !47, line: 73, type: !48, flags: DIFlagPrototyped | DIFlagNoReturn, spFlags: DISPFlagOptimized, retainedNodes: !4)
!47 = !DIFile(filename: "src/include/klee/klee.h", directory: "/build/klee/parts/klee")
