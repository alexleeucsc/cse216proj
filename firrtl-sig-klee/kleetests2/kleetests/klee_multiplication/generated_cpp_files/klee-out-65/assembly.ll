...
define linkonce_odr dso_local void @_Z8callmultILi10ELi21EEvv() #6 comdat {
  ...
  call void @_ZN4UIntILi21EmLi1EEC2Em(%class.UInt.0* noundef nonnull align 8 dereferenceable(8) %4, i64 noundef %16)
  ...
  %23 = call i64 @_ZNK4UIntILi10EmLi1EEmlILi21EEES_IXplLi10ET_ENSt11conditionalIXleplLi10ET_Li8EEhmE4typeEXquleplLi10ET_Li8ELi1EdvmiplplLi10ET_Li64ELi1ELi64EEERKS_IXT_ENS2_IXleT_Li8EEhmE4typeEXquleT_Li8ELi1EdvmiplT_Li64ELi1ELi64EEE(%class.UInt* noundef nonnull align 8 dereferenceable(8) %3, %class.UInt.0* noundef nonnull align 8 dereferenceable(8) %4)
  ...
  call void @_ZN4UIntILi31EmLi1EEC2Em(%class.UInt.3* noundef nonnull align 8 dereferenceable(8) %8, i64 noundef %27)
  %28 = call i8 @_ZNK4UIntILi31EmLi1EEeqERKS0_(%class.UInt.3* noundef nonnull align 8 dereferenceable(8) %7, %class.UInt.3* noundef nonnull align 8 dereferenceable(8) %8)
...
34:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.5, i64 0, i64 0), i32 noundef 29, i8* noundef getelementptr inbounds ([35 x i8], [35 x i8]* @__PRETTY_FUNCTION__._Z8callmultILi10ELi21EEvv, i64 0, i64 0)) #13
  unreachable
