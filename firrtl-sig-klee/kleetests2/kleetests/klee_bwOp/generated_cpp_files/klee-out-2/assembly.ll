; ModuleID = 'generated_cpp_files/klee_bwop_10_22.bc'
source_filename = "generated_cpp_files/klee_bwop_10_22.cpp"
...
$_Z8callbwopILi10ELi22EEvv = comdat any
...
$_ZNK4UIntILi10EmLi1EEanERKS0_ = comdat any
...
@.str.5 = private unnamed_addr constant [40 x i8] c"generated_cpp_files/klee_bwop_10_22.cpp\00", align 1
@__PRETTY_FUNCTION__._Z8callbwopILi10ELi22EEvv = private unnamed_addr constant [35 x i8] c"void callbwop() [w1 = 10, w2 = 22]\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_klee_bwop_10_22.cpp, i8* null }]
...
define dso_local noundef i32 @main() #5 {
  ...
  call void @_Z8callbwopILi10ELi22EEvv()
  ret i32 0
}

; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local void @_Z8callbwopILi10ELi22EEvv() #6 comdat {
  ...
  call void @_ZN4UIntILi10EmLi1EEC2Em(%class.UInt* noundef nonnull align 8 dereferenceable(8) %4, i64 noundef %16)
  ...
  %23 = call i64 @_ZNK4UIntILi10EmLi1EEanERKS0_(%class.UInt* noundef nonnull align 8 dereferenceable(8) %3, %class.UInt* noundef nonnull align 8 dereferenceable(8) %4)
...
34:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([40 x i8], [40 x i8]* @.str.5, i64 0, i64 0), i32 noundef 26, i8* noundef getelementptr inbounds ([35 x i8], [35 x i8]* @__PRETTY_FUNCTION__._Z8callbwopILi10ELi22EEvv, i64 0, i64 0)) #13
  unreachable
...
; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local i64 @_ZNK4UIntILi10EmLi1EEanERKS0_(%class.UInt* noundef nonnull align 8 dereferenceable(8) %0, %class.UInt* noundef nonnull align 8 dereferenceable(8) %1) #6 comdat align 2 {
  %3 = alloca %class.UInt, align 8
  %4 = alloca %class.UInt*, align 8
  ...
  call void @_ZN4UIntILi10EmLi1EEC2Ev(%class.UInt* noundef nonnull align 8 dereferenceable(8) %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_klee_bwop_10_22.cpp() #0 section ".text.startup" {
...
entry:
  call void @_GLOBAL__sub_I_klee_bwop_10_22.cpp()
  ret void
}
