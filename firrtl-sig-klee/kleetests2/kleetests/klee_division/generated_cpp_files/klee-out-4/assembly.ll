...
define linkonce_odr dso_local void @_Z7calldivILi10ELi24EEvv() #6 comdat {
  ...
  %27 = call i64 @_ZNK4UIntILi10EmLi1EEdvILi24EEES0_RKS_IXT_ENSt11conditionalIXleT_Li8EEhmE4typeEXquleT_Li8ELi1EdvmiplT_Li64ELi1ELi64EEE(%class.UInt* noundef nonnull align 8 dereferenceable(8) %3, %class.UInt.0* noundef nonnull align 8 dereferenceable(8) %4)
...
38:                                               ; preds = %0
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([44 x i8], [44 x i8]* @.str.5, i64 0, i64 0), i32 noundef 29, i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @__PRETTY_FUNCTION__._Z7calldivILi10ELi24EEvv, i64 0, i64 0)) #13
  unreachable
