...
define dso_local noundef i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %38 = shl i32 1, %37, !klee.check.shift !23
  %39 = sub nsw i32 %38, 1
  ...
  %44 = shl i32 1, %43, !klee.check.shift !23
  %45 = sub nsw i32 %44, 1
...
54:                                               ; preds = %52
  ...
  %59 = shl i64 %56, %58, !klee.check.shift !23
  %60 = or i64 %55, %59
  ...
  %64 = shl i32 1, %63, !klee.check.shift !23
...
81:                                               ; preds = %79
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0), i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #19
  unreachable
