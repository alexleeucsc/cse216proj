...
define dso_local noundef i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %21 = shl i32 1, %20, !klee.check.shift !23
  %22 = sub nsw i32 %21, 1
  ...
  %27 = shl i32 1, %26, !klee.check.shift !23
  %28 = sub nsw i32 %27, 1
  ...
  call void @_ZN4UIntC2Emi(%class.UInt* noundef nonnull align 8 dereferenceable(48) %6, i64 noundef %31, i32 noundef %32)
  %33 = load i64, i64* %3, align 8
  %34 = load i32, i32* %5, align 4
  invoke void @_ZN4UIntC2Emi(%class.UInt* noundef nonnull align 8 dereferenceable(48) %7, i64 noundef %33, i32 noundef %34)
          to label %35 unwind label %65

35:                                               ; preds = %0
  %36 = bitcast i64* %10 to i8*
  invoke void @klee_make_symbolic(i8* noundef %36, i64 noundef 8, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0))
...
37:                                               ; preds = %35
  ...
  %42 = shl i64 %39, %41, !klee.check.shift !23
  %43 = or i64 %38, %42
  ...
  %47 = shl i32 1, %46, !klee.check.shift !23
  ...
  invoke void @_ZN4UIntC2Emi(%class.UInt* noundef nonnull align 8 dereferenceable(48) %12, i64 noundef %54, i32 noundef %57)
...
60:                                               ; preds = %59
  %61 = invoke noundef zeroext i1 @_ZNK4UIntcvbEv(%class.UInt* noundef nonnull align 8 dereferenceable(48) %13)
...
64:                                               ; preds = %62
  call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0), i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i32 noundef 33, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #19
  unreachable
